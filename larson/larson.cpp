 ...
 * albeit a 20 pin Raspberry Pi version. It //requires// a Pi with a 
 * 40 pin GPIO bus, or it won't call the right pins in wiringPi.
 * It exists to demonstrate the use of wiringPi in its most basic mode,
 * digitalWrite.
*/
